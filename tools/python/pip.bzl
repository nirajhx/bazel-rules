...
load("//tools/python/pip_install:pip_repository.bzl", "pip_repository") # CHANGED: Use own VWNI rule for "pip download"
load("@rules_python//python/pip_install:repositories.bzl", "pip_install_dependencies")

def pip_download(requirements, name = "pip", **kwargs):
